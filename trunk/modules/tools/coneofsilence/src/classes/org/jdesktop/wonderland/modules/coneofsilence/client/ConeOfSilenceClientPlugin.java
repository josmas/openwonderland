 ...
 * $State:$
 */
package org.jdesktop.wonderland.modules.coneofsilence.client;
...
/**
 * Plugin to support the coneofsilence
 * @author jprovino
 */
public class ConeOfSilenceClientPlugin implements ClientPlugin,
    ...
    private static final Logger logger =
            Logger.getLogger(ConeOfSilenceClientPlugin.class.getName());
    ...
    public void primarySession(WonderlandSession session) {
        ...
        logger.warning("ConeOfSilence initialized, session " + session);
    }
