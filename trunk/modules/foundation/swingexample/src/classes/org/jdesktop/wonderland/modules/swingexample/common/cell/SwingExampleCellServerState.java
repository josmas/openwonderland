...
/**
 * The WFS server state class for SwingExampleCellMO.
 * 
 * @author deronj
 */
@XmlRootElement(name="swingexample-cell")
@ServerState
public class SwingExampleCellServerState extends App2DCellServerState {
    
    /** The user's preferred width of the Swing example window. */
    @XmlElement(name="preferredWidth")
    public int preferredWidth = 300;
    
    /** The user's preferred height of the Swing example window. */
    ...
    public String getServerClassName() {
        return "org.jdesktop.wonderland.modules.swingexample.server.cell.SwingExampleCellMO";
    }
    ...
    public String toString() {
        return super.toString() + " [SwingExampleCellServerState]: " +
