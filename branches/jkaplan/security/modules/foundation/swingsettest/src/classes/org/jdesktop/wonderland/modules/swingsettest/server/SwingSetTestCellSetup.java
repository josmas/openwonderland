...
/**
 * The WFS setup class for SwingSetTestCellMO.
 * 
 * @author deronj
 */
@XmlRootElement(name="swingsettest-cell")
public class SwingSetTestCellSetup extends BasicCellSetup implements Serializable, CellSetupSPI {
    ...
    public String toString() {
        return super.toString() + " [SwingSetTestCellSetup]: " +
