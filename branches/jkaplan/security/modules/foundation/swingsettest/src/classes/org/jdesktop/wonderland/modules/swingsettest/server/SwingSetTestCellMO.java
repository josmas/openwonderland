...
@ExperimentalAPI
public class SwingSetTestCellMO extends App2DCellMO implements BeanSetupMO {
	...
	SwingSetTestCellConfig config = new SwingSetTestCellConfig(pixelScale);
	...
	SwingSetTestCellSetup setup = (SwingSetTestCellSetup) setupData;
