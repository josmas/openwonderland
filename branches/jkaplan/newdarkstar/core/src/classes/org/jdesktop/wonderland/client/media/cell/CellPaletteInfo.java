...
public interface CellPaletteInfo {
    ...
    /**
     * Returns a slash-delimited category path under which to organize the
     * cell type in the palette (e.g. "2D Applications/Image Viewers").
     * 
     * @return The cell type category
     */
