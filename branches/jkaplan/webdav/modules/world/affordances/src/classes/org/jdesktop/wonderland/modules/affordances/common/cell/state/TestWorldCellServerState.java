 ...
 * @author jordanslott
 */
@XmlRootElement(name="affordances-testworld")
@XmlType(name="affordances-testworld")
        ...
        implements Serializable, CellServerStateSPI
{
    ...
    public String getServerClassName() {
        return "org.jdesktop.wonderland.modules.affordances.server.cell.TestWorldCellMO";
    }
}
