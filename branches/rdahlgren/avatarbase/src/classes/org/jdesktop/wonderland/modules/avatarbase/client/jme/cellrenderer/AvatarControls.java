...
public class AvatarControls extends ViewControls {
    ...
    public AvatarControls() {
        m_scheme = new DefaultCharacterControls(ClientContextJME.getWorldManager());
    ...
    public void clearInputClients()
    {
        ...
        m_scheme = inputGroup.getInputScheme();
    ...
    public void setJScene(JScene jscene) 
    {
        ...
        m_jscene = jscene;
        // Unsafe assumption!
        if (m_scheme instanceof DefaultCharacterControls)
            ((DefaultCharacterControls)m_scheme).setJScene(jscene);
        else
