...
package org.jdesktop.wonderland.common.tools.modules.jar;
...
import org.jdesktop.wonderland.common.tools.modules.Module;
import org.jdesktop.wonderland.common.tools.modules.ModuleArtResource;
import org.jdesktop.wonderland.common.tools.modules.ModulePlugin;
...
public class ModuleJarWriter {
    ...
    public void writeToJar(Module module, OutputStream os) throws IOException, JAXBException {
        ...
        if (module.getRepository() != null) {
            ...
            module.getRepository().encode(jos);
        }
         ...
         */
        Iterator<String> resourceIterator = module.getArtResources().iterator();
        while (resourceIterator.hasNext() == true) {
            ...
            ModuleArtResource resource = module.getArtResource(resourceName);
         ...
         */
        Iterator<String> pluginIterator = module.getPlugins().iterator();
        while (pluginIterator.hasNext() == true) {
            /* Write an entry for the directory */
            String pluginName = pluginIterator.next();
            ModulePlugin plugin = module.getPlugin(pluginName);
