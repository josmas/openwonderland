...
package org.jdesktop.wonderland.web.modules;
...
public class ModuleManager {
    ...
    public Collection<String> removeAll(Collection<ModuleInfo> removedModules) {
        ...
        while (it.hasNext() == true) {
            ...
            if (module != null && module.getInfo().equals(moduleInfo) == true) {
    ...
    private Map<ModuleInfo, State> getPresentModuleInfos() {
        ...
        while (it.hasNext() == true) {
            ...
            present.put(module.getInfo(), State.PENDING);
        }
        ...
        while (it2.hasNext() == true) {
            ...
            present.put(module.getInfo(), State.INSTALLED);
        }
