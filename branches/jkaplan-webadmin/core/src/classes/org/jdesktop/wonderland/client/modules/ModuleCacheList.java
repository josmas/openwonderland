...
public class ModuleCacheList {
    ...
    protected ModuleCacheList() {
        ...
        /* Put in some dummy information */
//        ModuleCache mc = new ModuleCache("server");
//        ModuleInfo info = new ModuleInfo("mpk20", 1, 0);
//        ModuleRepository repository = new ModuleRepository();
//        repository.setMaster("http://foo.net");
//        repository.setMirrors(new String[] {
//            "http://bar.net",
//            "http://192.18.37.42/compiled_models/"
//        });
//        mc.addModuleInfo("mpk20", info);
//        mc.addModuleRepository("mpk20", repository);
//        this.moduleCaches.put("server", mc);
    }
