...
//            WonderlandContext.getCellManager().insertCellInWorld(new SkyboxHackMO(new Vector3f(0, 0, 0), 80));
     ...
     //       WonderlandContext.getCellManager().insertCellInWorld(new MouseSpinCellMO(new Vector3f(-8, 8, 2), 1));
            WonderlandContext.getCellManager().insertCellInWorld(new MouseSpinCellMO(new Vector3f(-4, 8, 2), 1));
