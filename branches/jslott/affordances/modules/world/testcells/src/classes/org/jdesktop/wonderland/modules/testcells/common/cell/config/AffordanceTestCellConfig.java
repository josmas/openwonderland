...
/**
 * Configuration for affordance test cell type
 *
 * @author paulby
 */
public class AffordanceTestCellConfig extends CellConfig {
    ...
    public AffordanceTestCellConfig(Shape shape, float mass) {
        this(shape, mass, null, "TRANSLATE");
    }

    public AffordanceTestCellConfig(Shape shape, float mass, MaterialJME material, String affordanceType) {
        this.shape = shape;
        this.mass = mass;
