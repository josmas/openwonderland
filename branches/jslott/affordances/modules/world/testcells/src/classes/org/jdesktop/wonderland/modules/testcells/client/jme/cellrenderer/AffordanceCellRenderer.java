...
import org.jdesktop.wonderland.modules.testcells.client.cell.AffordanceTestCell;
 ...
 * @author paulby
 */
public class AffordanceCellRenderer extends BasicRenderer {

    public AffordanceCellRenderer(Cell cell) {
        super(cell);
    }
    ...
    protected float getMass() {
        return ((AffordanceTestCell)cell).getMass();
    }
