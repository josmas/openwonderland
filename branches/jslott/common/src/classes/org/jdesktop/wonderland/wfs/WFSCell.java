...
public abstract class WFSCell {
     ...
     */
    public abstract <T extends BasicCellSetup> T getCellSetup() throws FileNotFoundException, InvalidWFSCellException;
     ...
     */
    public abstract <T extends BasicCellSetup> void setCellSetup(T cellSetup) throws InvalidWFSCellException;
     ...
     */
    public abstract void writeCell() throws IOException, InvalidWFSCellException, JAXBException;
     ...
     * @throw IOException Upon general I/O error
     */
    public abstract void write() throws IOException, InvalidWFSCellException, JAXBException;
