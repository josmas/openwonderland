...
public class ModuleInfo implements Serializable {
     ...
     */
    public static ModuleInfo decode(InputStream is) throws JAXBException {
        return (ModuleInfo)ModuleInfo.unmarshaller.unmarshal(is);        
    }
    ...
    public static void main(String args[]) {
        try {
            ...
            info.setMajor(5);
            info.setMinor(3);
            info.encode(new FileOutputStream(new File("/Users/jordanslott/module.xml")));
            
            info = ModuleInfo.decode(new FileInputStream(new File("/Users/jordanslott/module.xml")));
