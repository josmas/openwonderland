...
public class FileDirectoryDelegate implements DirectoryDelegate {
    ...
    /**
     * Returns an output stream for the given file name in the root directory.
     * This is used to write meta-data such as the version file.
     * 
     * @name The name of the file
     * @return An output stream for a particular file
     */
    public OutputStream getOutputStream(String name) throws IOException {
        return new FileOutputStream(this.getFile() + "/" + name);
    }
