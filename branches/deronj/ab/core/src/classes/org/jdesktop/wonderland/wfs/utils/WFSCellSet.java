...
/**
 * The WFSCellSet class is a list of canonical cell names. The implementation of
 ...
 */
public class WFSCellSet extends LinkedList<String> implements ManagedObject, Serializable {
    
    /** Constructor takes a Set */
    public WFSCellSet(Set<String> set) {
        super(set);
    }
}
