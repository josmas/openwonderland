...
import org.jdesktop.wonderland.modules.appbase.client.gui.Window2DFrame;
...
public class FrameCloseButton extends FrameComponent {
    ...
    private static final float CLOSE_BUTTON_HEIGHT = FrameWorldDefault.HEADER_HEIGHT * 0.9f;
    ...
    protected LinkedList<Window2DFrame.CloseListener> closeListeners;
     ...
     */
    public LinkedList<Window2DFrame.CloseListener> getCloseListeners() {
    ...
    protected void updateLayout() {
        x = (view.getWidth() - CLOSE_BUTTON_WIDTH) / 2f + FrameWorldDefault.SIDE_THICKNESS;
        y = 0;
    }
