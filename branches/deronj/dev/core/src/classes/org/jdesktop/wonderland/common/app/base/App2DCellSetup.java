...
/**
 * The cell setup information used by generic 2D apps.
 *
 * @author deronj
 */

@ExperimentalAPI
public class App2DCellSetup extends AppCellSetup {
    ...
    /**
     * Create a new instance of App2DCellSetup with the default pixel scale.
     */
    public App2DCellSetup () {
	this(new Vector2f(DEFAULT_PIXEL_SCALE, DEFAULT_PIXEL_SCALE));
    }

    /**
     * Create a new instance of App2DCellSetup.
     *
     * @param pixelScale The pixel scale to use.
     */
    public App2DCellSetup (Vector2f pixelScale) {
     ...
     */
    public App2DCellSetup (float pixelScaleX, float pixelScaleY) {
