...
@ExperimentalAPI
public class AppConventionalCellSetup extends App2DCellSetup {
    ...
    /** 
     * Create a new instance of AppConventionalCellSetup with default state.
     */
    ...
    /** 
     * Create a new instance of AppConventionalCellSetup.
     *
     ...
     */
    public AppConventionalCellSetup (String masterHost, String appName, Vector2f pixelScale, 
