...
import org.jdesktop.wonderland.client.app.xremwin.Proto.SlaveCloseWindowMsgArgs;
...
import java.net.SocketException;
import org.jdesktop.wonderland.client.app.utils.clientsocket.ClientSocket;
...
class ServerProxyMaster extends ServerProxyMasterSocket {
    ...
    */
	...
	try {
	    ...
	    sf.broadcastSend(new ClientSocket.DisplayPixelsDataMessage(integerBuf));
	...
	try {
	    ...
	    sf.broadcastSend(new ClientSocket.DisplayPixelsDataMessage(chunkBuf));
	} catch (IOException e) {
	    throw new RuntimeException(e);
	}
    }
	...
	try {
	    ...
	    //System.err.print("DPCHUNK: ");
	    //print10bytes(chunkBuf);
	    sf.broadcastSend(new ClientSocket.DisplayPixelsDataMessage(chunkBuf, len));
	} catch (IOException e) {
	    throw new RuntimeException(e);
	}
    }
