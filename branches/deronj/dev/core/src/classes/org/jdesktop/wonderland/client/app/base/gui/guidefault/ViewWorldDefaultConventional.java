...
public class ViewWorldConventionalDefault extends ViewWorldDefault implements Window2DViewWorldConventional {
	...
	/*
	System.err.println("performDisplayPixels");
	System.err.println("dstX = " + dstX);
	System.err.println("dstY = " + dstY);
	System.err.println("width = " + width);
	System.err.println("height = " + height);
	System.err.println("dstWidth = " + dstWidth);
	System.err.println("dstHeight = " + dstHeight);
	*/
	...
	/*
	System.err.print("FSI.copyArea, srcXY = " + srcX + ", " + srcY);
	System.err.print(", wh = "  + width + ", " + height);
	System.err.println(", dstXY = " + dstX + ", " + dstY);
	*/
	...
	/*
	System.err.println("CopyArea: extracted pixels");
	printSubImageOfPackedImage(pixels, width, height, 10, 10);
	*/
    ...
    /* For Debug
    private static void printSubImageOfPackedImage (int[] pixels, int width, int height, 
						    int yToPrint, int xToPrint) {
	int idx = 0;
	int nextLineIdx = idx;

	for (int i = 0; i < yToPrint; i++) {
	    nextLineIdx += width;
	    for (int k = 0; k < xToPrint; k++) {
