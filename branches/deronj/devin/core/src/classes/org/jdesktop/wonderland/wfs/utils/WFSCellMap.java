...
/**
 * The WFSCellMap class is a mapping between the canonical name of the cell
 ...
 */
public class WFSCellMap<T> extends LinkedHashMap<String, T> implements ManagedObject, Serializable {
