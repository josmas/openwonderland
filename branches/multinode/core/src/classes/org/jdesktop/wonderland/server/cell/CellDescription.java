 ...
 */
@ExperimentalAPI
public class CellDescription implements ManagedObject, Serializable {
    ...
    private static final String BINDING_NAME=CellDescription.class.getName();
    
    
    /**
     * Creates a new instance of CellDescription
     */
    CellDescription() {
    ...
    public static CellDescription getCellManager() {
        return (CellDescription) AppContext.getDataManager().getBinding(BINDING_NAME);                
    }
    ...
    /**
     *  Traverse all trees and return the CellMirror for the cells which are within
     ...
     */
    @InternalAPI
    public CellMirror[] getCells(BoundingVolume b, Class<?>... cellClasses) {
        return new CellMirror[0];
    }
        ...
        for(int x=0; x<gridWidth; x++) {
            for(int z=0; z<gridDepth; z++) {
                try {
                    ...
                    Logger.getLogger(CellDescription.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        }
