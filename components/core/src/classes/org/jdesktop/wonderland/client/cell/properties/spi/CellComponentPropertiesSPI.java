...
/**
 * An interface implemented by cell components that allow their properties to be
 * edited in a dialog.
 * 
 * @author Jordan Slott <jslott@dev.java.net>
 */
@ExperimentalAPI
public interface CellComponentPropertiesSPI {

    /**
     * Returns the Class of the server-side component state.
     *
     * @return The server-side component state Class
     */
     ...
     *
     * @param editor The editor for all of the cell component's properties
     * @return A JPanel
     */
