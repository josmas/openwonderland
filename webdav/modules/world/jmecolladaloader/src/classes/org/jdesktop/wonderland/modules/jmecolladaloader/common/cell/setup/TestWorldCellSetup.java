...
public class TestWorldCellSetup extends BasicCellSetup 
        implements Serializable, CellSetupSPI
{
    /** Default constructor */
    public TestWorldCellSetup() {
    }
    
    @Override
    public String getServerClassName() {
        return "org.jdesktop.wonderland.modules.jmecolladaloader.server.cell.TestWorldCellMO";
    }
}
