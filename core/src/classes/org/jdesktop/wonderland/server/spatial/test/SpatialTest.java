...
public class SpatialTest {
    ...
    private UniverseImpl universe = new UniverseImpl();
    ...
    public SpatialTest() {
        ...
        universe.addSpatialCell(c);

        universe.addSpatialCell(createCell(new Vector3f(100,0,0), 4));
        universe.addSpatialCell(createCell(new Vector3f(130,1,1), 4));
        universe.addSpatialCell(createCell(new Vector3f(150,2,2), 4));

        SpatialCell v = createCell(new Vector3f(), 100, true);
        universe.addSpatialCell(v);
    ...
    private SpatialCell createCell(Vector3f translation, float size, boolean view) {
        SpatialCell ret = universe.createSpatialCell(new CellID(id++), view);
