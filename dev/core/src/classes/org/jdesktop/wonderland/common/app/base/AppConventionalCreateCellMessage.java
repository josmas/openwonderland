...
@InternalAPI
public abstract class AppConventionalCellCreateMessage extends AppConventionalMessage {
     ...
     */
    public Serializable getSubclassData () {
	return subclassdata;
    }
}
