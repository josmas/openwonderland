...
public class FrameResizeCorner extends FrameComponent {
	...
	System.err.println("vertY = " + vertY);
	System.err.println("vertWidthWorld = " + vertWidthWorld);
	System.err.println("vertHeightWorld = " + vertHeightWorld);
	...
	if (horizBar != null) {
	    System.err.println("horiz color = " + color);
	    horizBar.setColor(color);
	}
	if (vertBar != null) {
	    System.err.println("vert color = " + color);
