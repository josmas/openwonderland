...
import org.jdesktop.wonderland.client.app.base.App2D;
...
import org.jdesktop.wonderland.client.app.xremwin.Proto.MessageArgs;
import org.jdesktop.wonderland.client.app.xremwin.Proto.ServerMessageType;
import org.jdesktop.wonderland.client.app.util.stats.StatisticsReporter;
import org.jdesktop.wonderland.client.app.util.stats.StatisticsSet;
...
abstract class ClientXrw implements Runnable {
    ...
    */
	...
	protected void printStats () {
	    System.err.println("numRequests = " + numRequests);
	    System.err.println("displayPixelsNumBytes = " + displayPixelsNumBytes);
	    System.err.println("numCopyAreas = " + numCopyAreas);
	}
	...
	protected void printStatsAndRates (double timeSecs) {
	    ...
	    System.err.println("numRequestsPerSec = " + numRequestsPerSec);
	    double displayPixelsNumBytesPerSec = displayPixelsNumBytes / timeSecs;
	    System.err.println("displayPixelsNumBytes = " + displayPixelsNumBytesPerSec);
	    double numCopyAreasPerSec = numCopyAreas / timeSecs;
	    System.err.println("numCopyAreas = " + numCopyAreasPerSec);
	}
    }
}
