...
/**
 * The JEditor test is a Wonderland app. It currently is only launched from the world. 
 *
 * @author deronj
 */

@ExperimentalAPI
public class JEditorTestLaunchMethods extends AppLaunchMethodsWonderland {

    /** Create an instance of JEditorTestAppLaunchMethods */
    public JEditorTestLaunchMethods () {
