...
@ExperimentalAPI
class ProviderServerConnection extends BaseConnection {

    private static Logger logger = Logger.getLogger(ProviderServerConnection.class.getName());
    ...
    ProviderServerConnection (BigInteger clientID) {
	this.clientID = clientID;
    }

    public void registerLaunchListener (String executionCapability, LaunchListener listener) {
     ...
     */
    public boolean addExecutionCapability (String executionCapability, AppCollection apps) { 
     ...
     */
    public boolean removeExecutionCapability (String executionCapability, AppCollection apps) {
