 ...
 * @author jkaplan
 */
public class ServerManagerConnectionType extends ConnectionType {
    /** The server manager client type */
    public static final ConnectionType CONNECTION_TYPE =
            new ServerManagerConnectionType();
    
    /** Use the static CLIENT_TYPE, not this constructor */
    public ServerManagerConnectionType() {
        super ("__ServerManagerConnection");
    }
}
