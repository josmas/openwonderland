...
@ExperimentalAPI
public class SwingSetTestCellConfig extends App2DCellConfig {

    private static final Logger logger = Logger.getLogger(SwingSetTestCellConfig.class.getName());
    ...
    public SwingSetTestCellConfig () {
        this(null);
    }
    
    public SwingSetTestCellConfig (Vector2f pixelScale) {
	super(pixelScale);
    }
