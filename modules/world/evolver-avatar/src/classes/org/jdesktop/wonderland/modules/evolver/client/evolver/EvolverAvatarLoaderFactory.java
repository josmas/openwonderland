...
/**
 * Generates loaders to load the Evolver avatars on the client.
 *
 * @author Jordan Slott <jslott@dev.java.net>
 */
@AvatarLoaderFactory
public class EvolverAvatarLoaderFactory implements AvatarLoaderFactorySPI {

    /**
     * {@inheritDoc}
     */
    public AvatarLoaderSPI getAvatarLoader() {
        return new EvolverAvatarLoader();
    }
}
