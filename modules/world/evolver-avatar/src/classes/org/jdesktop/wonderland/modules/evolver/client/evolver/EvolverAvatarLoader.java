...
/**
 * Loads Evolver avatars on the client and generates an avatar character from it.
 *
 * @author Jordan Slott <jslott@dev.java.net>
 */
public class EvolverAvatarLoader implements AvatarLoaderSPI {

    private static Logger logger = Logger.getLogger(EvolverAvatarLoader.class.getName());
    ...
    public WlAvatarCharacter getAvatarCharacter(Cell viewCell, String userName,
        ...
        try {
            ...
            URL tmpURL = AssetUtils.getAssetURL("wlcontent://users/", serverHostAndPort);
