...
/**
 * Avatar pick geometry
 * @author Jonathan Kaplan <jonathankap@gmail.com>
 */
public class PickGeometry extends Node {
    ...
    public PickGeometry(String name, Cell cell, AvatarImiJME renderer,
                        PickBox[] boxes)
    {
    ...
    public static class PickBox extends Box implements Cloneable {
        ...
        public void attach(PickGeometry geometry) {
