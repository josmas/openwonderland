...
import org.jdesktop.wonderland.darkstar.common.messages.DataDouble;
import org.jdesktop.wonderland.darkstar.common.messages.DataInt;
import org.jdesktop.wonderland.common.simplewhiteboard.WhiteboardAction.Action;
import org.jdesktop.wonderland.common.simplewhiteboard.WhiteboardCommand.Command;
import org.jdesktop.wonderland.common.simplewhiteboard.WhiteboardTool.Tool;
...
public class CompoundWhiteboardCellMessage extends WhiteboardCellMessage {
    ...
    public CompoundWhiteboardCellMessage(ClientID clientID, CellID cellID, Action action) {
        super(clientID, cellID, action);
    }
    
    public CompoundWhiteboardCellMessage(ClientID clientID, CellID cellID, Action action, Point position) {
        super(clientID, cellID, action);
        setPosition(position);
    }
    
    public CompoundWhiteboardCellMessage(ClientID clientID, CellID cellID, Action action, Tool tool) {
        super(clientID, cellID, action, tool);
    }
    
    public CompoundWhiteboardCellMessage(ClientID clientID, CellID cellID, Action action, Command command) {
        super(clientID, cellID, action, command);
    }
    
    public CompoundWhiteboardCellMessage(ClientID clientID, CellID cellID, Action action, Color color) {
