...
@ExperimentalAPI
public class SwingSetTestCellClientState extends App2DCellClientState {

    private static final Logger logger = Logger.getLogger(SwingSetTestCellClientState.class.getName());
    ...
    public SwingSetTestCellClientState () {
        this(null);
    }
    
    public SwingSetTestCellClientState (Vector2f pixelScale) {
	super(pixelScale);
    }
